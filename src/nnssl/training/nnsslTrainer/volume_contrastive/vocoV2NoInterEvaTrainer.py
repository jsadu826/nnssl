...
from nnssl.architectures.vocoV2NoInter_architecture import VoCoV2NoInterEvaArchitecture
from nnssl.training.nnsslTrainer.volume_contrastive.vocoV2NoInterTrainer import VoCoV2NoInterTrainer
...
class VoCoV2NoInterEvaTrainer(VoCoV2NoInterTrainer):
    ...
    def build_architecture_and_adaptation_plan(
        ...
        architecture = VoCoV2NoInterEvaArchitecture(encoder, self.embed_dim)
...
class VoCoV2NoInterEvaTrainer_BS8(VoCoV2NoInterEvaTrainer):
    def __init__(
        self,
        plan: Plan,
        configuration_name: str,
...
class VoCoV2NoInterEvaTrainer_test(VoCoV2NoInterEvaTrainer):
    def __init__(
        self,
        plan: Plan,
        configuration_name: str,
